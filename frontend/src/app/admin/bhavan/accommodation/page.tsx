  ...
  return (
    <div className="space-y-6" suppressHydrationWarning>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-zinc-900">Accommodation Inventory</h1>
          <p className="text-xs sm:text-sm text-zinc-500 mt-0.5">Manage rooms, rates, quantity, and guest capacities in alphabetical order</p>
        </div>
      ...
      {viewingType && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl p-5 sm:p-6 w-full max-w-lg space-y-4 max-h-[90vh] overflow-y-auto shadow-xl">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-zinc-900">{viewingType.name}</h2>
              ...
              <div className="grid grid-cols-3 gap-2.5 sm:gap-3 mt-4">
                <div className="p-3 bg-amber-50/60 rounded-xl border border-amber-100">
                  ...
                  <span className="text-sm sm:text-base font-extrabold text-amber-600">₹{viewingType.base_price_per_night}</span>
                </div>
                <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100">
                  <span className="text-[10px] font-bold text-zinc-500 block uppercase">Total Units</span>
                  <span className="text-sm sm:text-base font-extrabold text-blue-700">{viewingType.units?.length || 0} Units</span>
                </div>
                <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100">
                  <span className="text-[10px] font-bold text-zinc-500 block uppercase">Capacity</span>
                  <span className="text-sm sm:text-base font-extrabold text-zinc-800">{viewingType.capacity_per_unit} Guests</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 pt-3 border-t border-zinc-100">
              <button
                onClick={() => setViewingType(null)}
                className="min-h-[44px] px-4 py-2.5 border border-zinc-200 rounded-xl text-xs sm:text-sm font-semibold hover:bg-zinc-50 cursor-pointer w-full sm:w-auto text-center"
              >
                Close
              </button>
              <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="flex flex-col justify-end">
                ...
                <input
                  ...
                  placeholder="e.g. 10"
                  className="w-full min-h-[44px] px-3.5 py-2 border border-zinc-200 rounded-xl text-sm font-bold text-zinc-800 focus:outline-none focus:border-amber-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
              </div>
            </div>
      ...
      {deletingType && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl p-5 sm:p-6 w-full max-w-sm space-y-4 text-center shadow-xl">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-bold text-zinc-900">Deactivate Accommodation?</h3>
