    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-zinc-100 py-20 text-center">
          ...
          <Link href="/dashboard/blog/new" className="mt-4 inline-flex items-center gap-1.5 text-amber-500 hover:underline text-sm font-medium">
          ...
          {filtered.map((blog, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <Link
                  href={`/dashboard/blog/${blog.blog_id}/edit`}
